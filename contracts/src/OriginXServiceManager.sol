...
import {IOriginXServiceManager} from "./IOriginXServiceManager.sol";
...
contract OriginXServiceManager is
    ECDSAServiceManagerBase,
    IOriginXServiceManager
{
    ...
    function respondToApproveTask(
        ...
        bytes32 messageHash = keccak256(
            abi.encodePacked("Hello, this is a signed message from the OriginX Service Manager.")
        );
